...
func NewUserRepository(dbConn *sql.DB) (*UserRepository, error) {
	repo := &UserRepository{dbConn: dbConn}
...
func (repo *UserRepository) Insert(user *User) (sql.Result, error) {
...
func (repo *UserRepository) getUser(stmt *sql.Stmt, arg interface{}) (*User, error) {
...
func (repo *UserRepository) Update(user *User) (sql.Result, error) {
